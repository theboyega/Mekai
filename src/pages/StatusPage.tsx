      ...
      <main className="flex-1 w-full px-6 sm:px-10 lg:px-14 xl:px-20 max-w-4xl mx-auto py-12 sm:py-16">
        ...
        <div className="mt-12 p-6 rounded-2xl bg-[#121616] border border-[#1E2525] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <a
            ...
            className="px-4 py-2.5 rounded-full bg-[#1A2121] hover:bg-[#242D2D] text-[#A3B18A] hover:text-white border border-[#263131] text-xs sm:text-sm font-semibold font-heading transition-colors inline-flex items-center justify-center shrink-0"
          >
