        ...
        <div className="border-b border-[#1E2525] pb-8 mb-10">
          ...
          <div className="mt-8 p-5 sm:p-6 rounded-2xl bg-[#121616] border border-[#1E2525] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a
              ...
              className="px-5 py-2.5 rounded-full bg-[#1A2121] hover:bg-[#242D2D] text-[#A3B18A] hover:text-white border border-[#263131] text-xs sm:text-sm font-semibold font-heading transition-colors inline-flex items-center justify-center self-start sm:self-auto shrink-0"
            >
              Send Media Enquiry
            </a>
          </div>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-5 sm:pl-6 border-l border-[#1E2525] space-y-3">
              ...
              <div className="pt-2">
                <a
                  href="mailto:press@mekai.ai?subject=Press%20Kit%20Request"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#121616] hover:bg-[#1A2121] border border-[#1E2525] text-xs font-semibold text-[#A3B18A] hover:text-white transition-colors"
                >
