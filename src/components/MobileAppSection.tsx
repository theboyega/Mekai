    ...
    <section id="download-section" className="py-16 sm:py-20 lg:py-24 border-t border-[#1C2121]/60 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div id="download-content" className="lg:col-span-6">
            ...
            <div id="store-buttons" className="flex flex-wrap items-center gap-3.5">
              ...
              <button
                ...
                className="px-6 py-3 rounded-full bg-[#131616] border border-[#2B3232] hover:border-[#A3B18A]/70 hover:bg-[#181D1D] active:scale-95 text-white font-medium text-sm transition-all duration-200 inline-flex items-center gap-2.5 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#A3B18A]"
              >
                {/* Apple Logo SVG */}
          ...
          <div id="download-mockup-wrapper" className="lg:col-span-6 flex justify-center lg:justify-end">
            <PhoneMockups />
          </div>
