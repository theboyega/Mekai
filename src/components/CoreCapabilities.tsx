        ...
        <div id="capabilities-grid" className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-7">
          ...
          <ScrollReveal animation="fade-up" duration={480} delay={80} className="h-full">
            <div
              ...
              className="h-full rounded-[22px] bg-[#A3B18A] text-[#0E1111] p-7 sm:p-8 flex flex-col justify-between min-h-[290px] transition-transform duration-300 hover:-translate-y-1 shadow-lg"
            >
              <div>
                ...
                <div className="w-11 h-11 mb-8 flex items-center justify-center text-[#0E1111]" aria-hidden="true">
                  <CircleGauge className="w-8 h-8 stroke-2" />
                </div>
          ...
          <ScrollReveal animation="fade-up" duration={480} delay={160} className="h-full">
            <div
              ...
              className="h-full rounded-[22px] bg-[#FFFFFF] text-[#0E1111] p-7 sm:p-8 flex flex-col justify-between min-h-[290px] transition-transform duration-300 hover:-translate-y-1 shadow-lg"
            >
              <div>
          ...
          <ScrollReveal animation="fade-up" duration={480} delay={240} className="h-full">
            <div
              ...
              className="h-full rounded-[22px] bg-[#131616] border border-[#232828] text-white p-7 sm:p-8 flex flex-col justify-between min-h-[290px] transition-transform duration-300 hover:-translate-y-1 hover:border-[#313939] shadow-lg"
            >
              <div>
                {/* Component Scan Icon */}
