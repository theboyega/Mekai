        ...
        <div id="workflow-grid" className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-7">
          {steps.map((item, index) => (
            <div
              ...
              className="rounded-[22px] bg-[#131616] border border-[#222828] p-7 sm:p-8 flex flex-col justify-start min-h-[220px] transition-all duration-300 hover:border-[#333C3C] hover:bg-[#151919]"
            >
