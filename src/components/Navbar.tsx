...
import { KeyRound, LogOut, X, ArrowRight, Layers, BarChart3, Smartphone, Cpu } from 'lucide-react';
    ...
    <>
      ...
      >
        <div className="w-full px-6 sm:px-10 lg:px-14 xl:px-20 h-20 sm:h-24 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm font-medium text-[#9EA8A8]">
            <button
              type="button"
